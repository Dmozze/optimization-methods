...
//    0	0	0	0	0	0	0	0	6
    ...
    LUMatrix lu({0, 1, 1, 0, 4, 6, 0, 0, 2, 4, 0, 3, 7, 9},
                {0, 3, 6, 0, 7, 9, 0, 0, 3, 5, 0, 1, 4, 3},
                {4, 6, 1, 4, 7, 5, 6, 8, 6},
                {0, 0, 2, 5, 9, 11, 13, 13, 13});
    print_lu(lu);
}
...
//    0	 0	0	 0	 0	 0	 0	 0	 0	7
    ...
    LUMatrix lu({0, 0, 12, 0, 4, 5, 0, 0, 6, 52, 7, 0, 63, 15,  0, 99, 6, 80},
                {0, 0,  6, 0, 9, 3, 0, 0, 6, 18, 5, 0,  4, 12,  0,  9, 2,  9},
                {5, 6, 1, 15, 43, 30, 27, 16, 66, 7},
                {0, 0, 2, 5, 8, 12, 15, 17, 17, 17, 17});
    print_lu(lu);
}
